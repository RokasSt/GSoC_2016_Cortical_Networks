...
def PlotNC_vs_NML2(targets_to_plot,legend=False,save_to_file=None,nCcellPath=None,NML2cellPath=None):
    ...
    if len(targets_to_plot['NML2'])==len(targets_to_plot['nC']):
       ...
       if (no_of_pairs % 4) >= 1:
          rows = max(1,int(math.ceil(no_of_pairs/4)+1))
       else:
          rows=max(1,int(math.ceil(no_of_pairs/4)))
       columns = min(4,no_of_pairs)
       ...
       for pair in range(0,no_of_pairs):
           ...
           if no_of_pairs >1:
              ax[pair].used = True
              ax[pair].set_title(subplot_titles[pair],size=14)
              ax[pair].locator_params(tight=True, nbins=10)
           else:
              ax.used = True
              ax.set_title(subplot_titles[pair],size=14)
           ...
           if no_of_pairs >1:
              ...
              for tick in ax.xaxis.get_major_ticks():
                  tick.label.set_fontsize(9)   
       if legend:
          ax[0].legend(loc='upper center',bbox_to_anchor=(1.1, 1.12),fontsize=16, fancybox=True,ncol=3, shadow=True)
       plt.tight_layout()
...
'Sim_Cell12_deepLTS_10ms.CGdeepLTS.v','Sim_Cell14_nRT_10ms.CGnRT_min75init.v'],
   ...
   'Cell4-supaxax-10ms','Cell5-supLTS-10ms','Cell7-tuftIB-10ms','Cell8-tuftRS-10ms','Cell9-nontuftRS-10ms','Cell10-deepbask-10ms','Cell11-deepaxax-10ms','Cell12-deepLTS-10ms','Cell14-nRT-10ms']},save_to_file='Test_more_10ms.pdf',legend=False)
...
'Sim_Cell14_nRT_FigA8_300.CGnRT.v','Sim_Cell14_nRT_FigA8_500.CGnRT.v'],
   ...
   ['Cell1-supppyrRS-FigA1RS','Cell2-suppyrFRB-FigA1FRB','Cell3-supbask-FigA2a','Cell4-supaxax-FigA2a','Cell5-supLTS-FigA2b','Cell7-tuftIB-FigA4-900','Cell7-tuftIB-FigA4-1100','Cell7-tuftIB-FigA4-1300','Cell7-tuftIB-FigA4-1500','Cell8-tuftRS-FigA5-800','Cell8-tuftRS-Fig5A-1000','Cell8-tuftRS-Fig5A-1200','Cell8-tuftRS-Fig5A-1400','Cell9-nontuftRS-FigA6-500','Cell9-nontuftRS-FigA6-800','Cell9-nontuftRS-FigA6-1000','Cell12-deepLTS-FigA2b','Cell14-nRT-FigA8-00','Cell14-nRT-FigA8-300','Cell14-nRT-FigA8-500']},save_to_file='Test_more_figs.pdf',legend=False)
