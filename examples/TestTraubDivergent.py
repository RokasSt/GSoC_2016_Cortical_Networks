...
nml_doc, network = oc.generate_network("TestTraubDivergent")
...
synapseList,projArray=oc.build_connectivity(network,popObjs,conn_dict_Traub,"../NeuroML2/prototypes/Thalamocortical/")                  
